...
<div class="div1">
    ...
    <div class="div3">
    <form action="loginafter.php?act=login" method="post">
    	<div class="div4">
        	<img style="float:left;" src="Images/people.png" />
    		<input class="input1" name="PhoneNum" type="tel" placeholder="请输入手机号" /><br />
        </div>
        <div class="div5">
        ...
        <div class="div6">
        	<input class="input3" onclick="submit();" type="button" value="登录" />
            <input class="input4" type="reset" value="重置" />
        </div>
    </form>
    <a class="a1" href="register.php">还没有账号？去注册一下吧</a>
    </div>
</div>
</center>
</body>
